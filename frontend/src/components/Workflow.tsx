	...
	return (
		<div className="flex justify-center">
			...
			<g id="sentence_transformer">
				<g className={props.focusComponent === 'sentence_transformers' || props.focusComponent === 'datasets' ? 'cls-13-focus' : "cls-13"}>
				...
				<text className={props.focusComponent === 'sentence_transformers' || props.focusComponent === 'datasets' ? 'cls-34-focus' : 'cls-34'} transform="translate(598.96 231.9)"><tspan x="10" y="0">Sentence</tspan><tspan className="cls-100" x="0" y="18">Transformer</tspan></text>
			</g>
			<g>
			...
			<text className="cls-60" transform="translate(1068.61 102.34)"><tspan x="0" y="0">Llama3* + Gemma*</tspan></text>
