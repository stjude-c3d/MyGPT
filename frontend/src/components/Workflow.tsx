	...
	return (
		<div className="flex justify-center">
			...
			<g id="sentence_transformer">
				...
				<text className={props.focusComponent === 'embedding_models' || props.focusComponent === 'datasets' ? 'cls-34-focus' : 'cls-34'} transform="translate(598.96 231.9)"><tspan x="0" y="0">Embedding</tspan><tspan className="cls-100" x="22" y="18">Model</tspan></text>
			</g>
			<g>
