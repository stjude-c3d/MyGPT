const defaultSettings = {
	...
	llms: [import.meta.env.REACT_APP_DEFAULT_LLM || 'llama3:latest'],
    defaultLlm: import.meta.env.REACT_APP_DEFAULT_LLM || 'llama3:latest',
	selectedLlm: import.meta.env.REACT_APP_DEFAULT_LLM || 'llama3:latest',
    datasets: ['None'],
	defaultDataset: 'None',
