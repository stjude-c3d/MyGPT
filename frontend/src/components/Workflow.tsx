	...
	return (
		<div className="flex justify-center">
			...
			<g id="sentence_transformer">
				<g className={props.focusComponent === 'embedding_models' || props.focusComponent === 'datasets' ? 'cls-13-focus' : "cls-13"}>
				...
				<text className={props.focusComponent === 'embedding_models' || props.focusComponent === 'datasets' ? 'cls-34-focus' : 'cls-34'} transform="translate(598.96 231.9)"><tspan x="10" y="0">Sentence</tspan><tspan className="cls-100" x="0" y="18">Transformer</tspan></text>
			</g>
			<g>
